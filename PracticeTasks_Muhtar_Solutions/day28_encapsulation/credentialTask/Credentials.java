package PracticeTasks_Muhtar_Solutions.day28_encapsulation.credentialTask;
...
public class Credentials {
    ...
    public void setPassword(String password) {
        ...
        if (isStrongPassword(password)){ // if it is true , so if isStrongPassword method returns true...
    ...
    public boolean isStrongPassword(String password){
        ...
        if (hasDigit && hasLetter && hasSpecial && isStrongPassWord) {
            return true;
        }else{
            return false;
    ...
    public boolean isStrongPassword(String password){
        ...
        return r1 && r2 && r3 && r4 && r5; // either returns true or false
