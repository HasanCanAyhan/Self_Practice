...
public class CydeoStudent extends Student{
    ...
    public CydeoStudent(String name, int age, char gender, String studentId, String fieldOfStudy, String grade, String schoolName, int batchNumber, int groupNumber, String programmingLanguage) {
    ...
    @Override
    public void eat() {
        System.out.println(getClass().getSimpleName() + " " + getName() + " eats fast-food");
    }

    @Override
    public void drink() {
        System.out.println(getClass().getSimpleName() + " " + getName() + " drinks water");
    }

    @Override
    public void sleep() {
        System.out.println(getClass().getSimpleName() + " " + getName() + " can not sleep more than 6 hours");
    }
