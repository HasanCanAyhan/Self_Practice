...
public  class Tesla extends Car {
    ...
    // Setters and Getters can be overridden also.
    // SET METHOD OVERRIDING
    ...
    public void setModel(String model) {
        ...
        super.setModel(model);//That means -->> this.model = model;
        //super. : calls instance variable & instance methods  from parent class
        //super(): calls the constructor from parent class
    ...
    public void setYear(int year) {
        ...
        super.setYear(year); // this.year = year;
    }
    ...
    public void setPrice(double price) {
        ...
        super.setPrice(price); // call the setPrice methods from Parent - Car Class
    }
