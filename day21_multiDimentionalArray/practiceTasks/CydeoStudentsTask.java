...
public class CydeoStudentsTask { // Task1
    ...
    public static void main(String[] args) {
        ...
        String[][] batch1Groups = { batch1Group1, batch1Group2, batch1Group3  }; // inside 1D Arrays
        ...
        String[][] batch2Groups = { batch2Group1, batch2Group2, batch2Group3   }; // inside 1D Arrays


        String[][][] cydeoStudents = {  batch1Groups ,  batch2Groups  };   // inside 2D Arrays


        for (String[][] each2DArr : cydeoStudents) {
